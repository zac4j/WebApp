...
public class PhotoManager {
    ...
    public static File compressImage(String imageFilePath) {
        ...
        try {
            ...
            file = ImageUtils.compressImage(imageFilePath, 720, 1280, Bitmap.CompressFormat.JPEG, 80,
                destination);
        } catch (IOException e) {
    ...
    private static void logFileInfo(File file) {
        Log.d(TAG, "File path: " + file.getAbsolutePath() + ",size: " + readFileSize(
            file.length()));
    }
    ...
    public static void closeQuietly(Closeable closeable) {
        if (closeable != null) {
            try {
                ...
                Log.e("close closable", "This is an error while close stream: " + e.getMessage());
            }
        }
    }
}
